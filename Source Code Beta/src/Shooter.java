...
public class Shooter {	
	...
	public Shooter(GameState game){
		...
		game_arrow = new Arrow(GameState.frameWidth/2, GameState.frameHeight - 200, 0, 0, game);
		game_powerbar = new PowerBar(GameState.frameWidth/2, GameState.frameHeight - 200, 0, 0, game);
	}
